...
**Описание:**
- **green-hills.jpg** — исходное изображение.
- **green-hills-rgb.png** — после гистограммного выравнивания по каналам RGB: цвета становятся ярче, контраст выше, но иногда появляются неестественные оттенки.
- **green-hills-hls.png** — после гистограммного выравнивания по яркости (HLS): детали вытягиваются мягче, цвета сохраняются более натуральными, артефакты минимальны.
